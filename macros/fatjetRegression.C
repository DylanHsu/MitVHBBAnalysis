...
void fatjetRegression(TString extraString="") {
  ...
  //dataloader->AddTarget("fj1_genMnu/fj1_MSD","fj1_genMnu/fj1_MSD", "", 'F');
  ...
  //TCut preselectionCut = "fj1_genMnu/fj1_MSD>0.5 && fj1_genMnu/fj1_MSD<3 && fj1_genMnu<250";
  ...
  factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT", "!H:!V:NegWeightTreatment=Pray:BoostType=Grad:Shrinkage=0.2:SeparationType=RegressionVariance:nCuts=10000:MaxDepth=15:MinNodeSize=0.2%:NTrees=400" );
