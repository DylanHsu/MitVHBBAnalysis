...
void whbbMVA(
  ...
  if(useMulticlass) {
    dataloader->AddTree(plotTree,"Signal" ,1.0, TString(vhbbPlot::trainTreeEventSplitStr + "&& (theCategory==12)"                                                                 ).Data(), "train");
    dataloader->AddTree(plotTree,"W+udcsg",1.0, TString(vhbbPlot::trainTreeEventSplitStr + "&& (theCategory==8)"                                                                  ).Data(), "train");
    dataloader->AddTree(plotTree,"W+b(b)" ,1.0, TString(vhbbPlot::trainTreeEventSplitStr + "&& (theCategory==6||theCategory==7)"                                                  ).Data(), "train");
    dataloader->AddTree(plotTree,"Top"    ,1.0, TString(vhbbPlot::trainTreeEventSplitStr + "&& (theCategory==4||theCategory==5)"                                                  ).Data(), "train");
    dataloader->AddTree(plotTree,"Other"  ,1.0, TString(vhbbPlot::trainTreeEventSplitStr + "&& (theCategory==2||theCategory==3||theCategory==9||theCategory==10||theCategory==11)").Data(), "train"); // no QCD
    dataloader->AddTree(plotTree,"Signal" ,1.0, TString(vhbbPlot::testTreeEventSplitStr + "&& (theCategory==12)"                                                                 ).Data(), "test");
    dataloader->AddTree(plotTree,"W+udcsg",1.0, TString(vhbbPlot::testTreeEventSplitStr + "&& (theCategory==8)"                                                                  ).Data(), "test");
    dataloader->AddTree(plotTree,"W+b(b)" ,1.0, TString(vhbbPlot::testTreeEventSplitStr + "&& (theCategory==6||theCategory==7)"                                                  ).Data(), "test");
    dataloader->AddTree(plotTree,"Top"    ,1.0, TString(vhbbPlot::testTreeEventSplitStr + "&& (theCategory==4||theCategory==5)"                                                  ).Data(), "test");
    dataloader->AddTree(plotTree,"Other"  ,1.0, TString(vhbbPlot::testTreeEventSplitStr + "&& (theCategory==2||theCategory==3||theCategory==9||theCategory==10||theCategory==11)").Data(), "test"); // no QCD
    dataloader->SetWeightExpression("weight", "Signal");
    dataloader->SetWeightExpression("weight", "W+udcsg");
    dataloader->SetWeightExpression("weight", "W+b(b)");
    dataloader->SetWeightExpression("weight", "Top" );
    dataloader->SetWeightExpression("weight", "Other" );
  } else {
    dataloader->AddTree(plotTree,"Signal",1.0, TString(vhbbPlot::trainTreeEventSplitStr + "&& (theCategory==12)").Data(), "train");
    dataloader->AddTree(plotTree,"Background",1.0, TString(vhbbPlot::trainTreeEventSplitStr + "&& (theCategory==2||theCategory==3||theCategory==4||theCategory==5||theCategory==6||theCategory==7||theCategory==8||theCategory==9||theCategory==10||theCategory==11)").Data(), "train"); // no qcd
    dataloader->AddTree(plotTree,"Signal",1.0, TString(vhbbPlot::testTreeEventSplitStr + "&& (theCategory==12)").Data(), "test");
    dataloader->AddTree(plotTree,"Background",1.0, TString(vhbbPlot::testTreeEventSplitStr + "&& (theCategory==2||theCategory==3||theCategory==4||theCategory==5||theCategory==6||theCategory==7||theCategory==8||theCategory==9||theCategory==10||theCategory==11)").Data(), "test"); // no qcd
    dataloader->SetWeightExpression("weight", "Signal");
  ...
  psi["012002011002"] = "psi012002011002 := fj1ECFN_1_2_20/pow(TMath::Max(0.,fj1ECFN_1_2_10),2.00)";
  psi["014003022003"] = "psi014003022003 := fj1ECFN_1_3_40/pow(TMath::Max(0.,fj1ECFN_2_3_20),1.00)";
  psi["031003014003"] = "psi031003014003 := fj1ECFN_3_3_10/pow(TMath::Max(0.,fj1ECFN_1_3_40),0.75)";
  psi["031003022003"] = "psi031003022003 := fj1ECFN_3_3_10/pow(TMath::Max(0.,fj1ECFN_2_3_20),0.75)";
  psi["032003034003"] = "psi032003034003 := fj1ECFN_3_3_20/pow(TMath::Max(0.,fj1ECFN_3_3_40),0.50)";
  psi["012004011003"] = "psi012004011003 := fj1ECFN_1_4_20/pow(TMath::Max(0.,fj1ECFN_1_3_10),2.00)";
  psi["014004012003"] = "psi014004012003 := fj1ECFN_1_4_40/pow(TMath::Max(0.,fj1ECFN_1_3_20),2.00)";
  psi["020504010503"] = "psi020504010503 := fj1ECFN_2_4_05/pow(TMath::Max(0.,fj1ECFN_1_3_05),2.00)";
  psi["021004011003"] = "psi021004011003 := fj1ECFN_2_4_10/pow(TMath::Max(0.,fj1ECFN_1_3_10),2.00)";
  psi["021004020503"] = "psi021004020503 := fj1ECFN_2_4_10/pow(TMath::Max(0.,fj1ECFN_2_3_05),2.00)";
  psi["022004012003"] = "psi022004012003 := fj1ECFN_2_4_20/pow(TMath::Max(0.,fj1ECFN_1_3_20),2.00)";
  ...
  if(isBoosted) {
    ...
    //dataloader->AddVariable( "isojetNBtags"                      , "Iso. loose b-jets"                 , ""           , 'I');
    //dataloader->AddVariable( maxSubjetCSV                        , "FJ max subjet B-tag"               , ""           , 'F');
    ...
    //dataloader->AddVariable( "pfmetsig"                          , "E_{T}^{miss} sig."                 , "#sqrt{GeV}" , 'F');
    ...
    //dataloader->AddVariable( psi["012004010502"]                 , "#psi(1,2.0,4,1,0.5,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["021003011002"]                 , "#psi(2,1.0,3,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["022004011002"]                 , "#psi(2,2.0,4,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["020503010502"]                 , "#psi(2,0.5,3,1,0.5,2)"             , ""           , 'F'); //useful but poorly modeled
    //dataloader->AddVariable( psi["022003012002"]                 , "#psi(2,2.0,3,1,2.0,2)"             , ""           , 'F'); //useful but poorly modeled
    //dataloader->AddVariable( psi["012004020503"]                 , "#psi(1,2.0,4,2,0.5,3)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["032003012002"]                 , "#psi(3,2.0,3,1,2.0,2)"             , ""           , 'F');  //useful but poorly modeled
    //dataloader->AddVariable( psi["012003011002"]                 , "#psi(1,2.0,3,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["011003010502"]                 , "#psi(1,1.0,3,1,0.5,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["031003011002"]                 , "#psi(3,1.0,3,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["031003012002"]                 , "#psi(3,1.0,3,1,2.0,2)"             , ""           , 'F'); //useful but poorly modeled
    //dataloader->AddVariable( psi["030503011002"]                 , "#psi(3,0.5,3,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["022004012002"]                 , "#psi(2,2.0,4,1,2.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["021004011002"]                 , "#psi(2,1.0,4,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["012004011002"]                 , "#psi(1,2.0,4,1,1.0,2)"             , ""           , 'F');
    ...
    //dataloader->AddVariable( psi["012004011003"]                 , "#psi(1,2.0,4,1,1.0,3)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["012004021004"]                 , "#psi(1,2.0,4,2,1.0,4)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["021004012004"]                 , "#psi(2,1.0,4,1,2.0,4)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["011003020503"]                 , "#psi(1,1.0,3,2,0.5,3)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["020503011003"]                 , "#psi(2,0.5,3,1,1.0,3)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["012003030503"]                 , "#psi(1,2.0,3,3,0.5,3)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["030503012003"]                 , "#psi(3,0.5,3,1,2.0,3)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["010503010502"]                 , "#psi(1,0.5,3,1,0.5,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["020503011002"]                 , "#psi(2,0.5,3,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["011003011002"]                 , "#psi(1,1.0,3,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["020504011002"]                 , "#psi(2,0.5,4,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["012004021003"]                 , "#psi(1,2.0,4,2,1.0,3)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["012004012002"]                 , "#psi(1,2.0,4,1,2.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["020504020503"]                 , "#psi(2,0.5,4,2,0.5,3)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["011004011002"]                 , "#psi(1,1.0,4,1,1.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["021004012002"]                 , "#psi(2,1.0,4,1,2.0,2)"             , ""           , 'F'); 
    //dataloader->AddVariable( psi["021003012002"]                 , "#psi(2,1.0,3,1,2.0,2)"             , ""           , 'F');
    //dataloader->AddVariable( psi["011004020503"]                 , "#psi(1,1.0,4,2,0.5,3)"             , ""           , 'F'); 
    ...
    //dataloader->AddVariable( psi["031003014003"]                 , "#psi(3,1.0,3,1,4.0,3)"             , ""           , 'F');
    //dataloader->AddVariable( psi["031003022003"]                 , "#psi(3,1.0,3,2,2.0,3)"             , ""           , 'F');
    //dataloader->AddVariable( psi["032003034003"]                 , "#psi(3,2.0,3,3,4.0,3)"             , ""           , 'F');
    //dataloader->AddVariable( psi["012004011003"]                 , "#psi(1,2.0,4,1,1.0,3)"             , ""           , 'F');
    //dataloader->AddVariable( psi["014004012003"]                 , "#psi(1,4.0,4,1,2.0,3)"             , ""           , 'F');
    //dataloader->AddVariable( psi["020504010503"]                 , "#psi(2,0.5,4,1,0.5,3)"             , ""           , 'F');
    //dataloader->AddVariable( psi["021004011003"]                 , "#psi(2,1.0,4,1,1.0,3)"             , ""           , 'F');
    ...
    dataloader->AddVariable( "topWBosonPt"                       , "W boson p_{T}"                     , "GeV"        , 'F');
    dataloader->AddVariable( "bDiscrMin"                         , "Lesser AK4 b-tag"                  , ""           , 'F');
    dataloader->AddVariable( "topMassLep1Met"                    , "Top mass"                          , "GeV"        , 'F');
    dataloader->AddVariable( "deltaPhiVH"                        , "#Delta#phi(W,H)"                   , "Rad"        , 'F');
    dataloader->AddVariable( "nAJ := nJet-2"                     , "Additional AK4 jets"               , ""           , 'I');
    dataloader->AddVariable( "deltaPhiLep1Met"                   , "#Delta#phi(lepton,p_{T}^{miss})"   , "Rad"        , 'F');
    dataloader->AddVariable( "mT"                                , "W boson m_{T}"                     , "GeV"        , 'F');
    dataloader->AddVariable( "pfmet"                             , "p_{T}^{miss}"                      , "GeV"        , 'F');
    dataloader->AddVariable( "nSoft5"                            , "N^{soft}_{5}"                      , ""           , 'I');
    ...
    if(variableSet!="orthodox") {
      ...
      dataloader->AddVariable( "lepton1Flav"                       , "Lepton flavor"                     , ""           , 'I');
      dataloader->AddVariable( "lepton1Charge"                     , "Lepton charge"                     , ""           , 'I');
      dataloader->AddVariable( "bDiscrMax"                         , "Greater AK4 b-tag"                 , ""           , 'F');
      dataloader->AddVariable( "pfmetsig"                          , "E_{T}^{miss} sig."                 , "#sqrt{GeV}" , 'F');
      dataloader->AddVariable( "sumEtSoft1"                        , "#sum E_{T}(soft 1)"                , "GeV"        , 'F');
      dataloader->AddVariable( "nSoft2"                            , "N^{soft}_{2}"                      , ""           , 'I');
      dataloader->AddVariable( "nSoft10"                           , "N^{soft}_{10}"                     , ""           , 'I');
      dataloader->AddVariable( "topWBosonCosThetaCS"               , "W boson cos #theta^{CS}"           , ""           , 'F');
      dataloader->AddVariable( "hbbCosThetaJJ"                     , "cos #theta(bb)"                    , ""           , 'F');
      dataloader->AddVariable( "hbbCosThetaCSJ1"                   , "cos #theta^{CS} harder b"          , ""           , 'F');
      dataloader->AddVariable( "hbbJet1Pt"                         , "p_{T}(b1)"                         , "GeV"        , 'F');
      dataloader->AddVariable( "hbbJet2Pt"                         , "p_{T}(b2)"                         , "GeV"        , 'F');
      dataloader->AddVariable( dPhil1W                             , "#Delta#phi(lep,W)"                 , "Rad"        , 'F');
      dataloader->AddVariable( dPhil1b1                            , "#Delta#phi(lep,b1)"                , "Rad"        , 'F');
      dataloader->AddVariable( dPhil1b2                            , "#Delta#phi(lep,b2)"                , "Rad"        , 'F');
      dataloader->AddVariable( dPhiWb1                             , "#Delta#phi(W,b1)"                  , "Rad"        , 'F');
      dataloader->AddVariable( dPhiWb2                             , "#Delta#phi(W,b2)"                  , "Rad"        , 'F');
      dataloader->AddVariable( dPhib1b2                            , "#Delta#phi(b1,b2)"                 , "Rad"        , 'F');
      dataloader->AddVariable( dEtal1W                             , "|#Delta#eta(lep,W)|"               , ""           , 'F');
      dataloader->AddVariable( dEtal1b1                            , "|#Delta#eta(lep,b1)|"              , ""           , 'F');
      dataloader->AddVariable( dEtal1b2                            , "|#Delta#eta(lep,b2)|"              , ""           , 'F');
      dataloader->AddVariable( dEtaWb1                             , "|#Delta#eta(W,b1)|"                , ""           , 'F');
      dataloader->AddVariable( dEtaWb2                             , "|#Delta#eta(W,b2)|"                , ""           , 'F');
      dataloader->AddVariable( dEtab1b2                            , "|#Delta#eta(b1,b2)|"               , ""           , 'F');
    }
    ...
    if(variableSet=="everything") {
      ...
      dataloader->AddVariable( psi["021003011002"]                 , "#psi(2,1.0,3,1,1.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["022004011002"]                 , "#psi(2,2.0,4,1,1.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["020503010502"]                 , "#psi(2,0.5,3,1,0.5,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["022003012002"]                 , "#psi(2,2.0,3,1,2.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["012004020503"]                 , "#psi(1,2.0,4,2,0.5,3)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["021004020503"]                 , "#psi(2,1.0,4,2,0.5,3)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["032003012002"]                 , "#psi(3,2.0,3,1,2.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["012003011002"]                 , "#psi(1,2.0,3,1,1.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["011003010502"]                 , "#psi(1,1.0,3,1,0.5,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["031003011002"]                 , "#psi(3,1.0,3,1,1.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["031003012002"]                 , "#psi(3,1.0,3,1,2.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["030503011002"]                 , "#psi(3,0.5,3,1,1.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["022004012002"]                 , "#psi(2,2.0,4,1,2.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["021004011002"]                 , "#psi(2,1.0,4,1,1.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["012004011002"]                 , "#psi(1,2.0,4,1,1.0,2)"             , ""           , 'F'); 
      ...
      dataloader->AddVariable( psi["022004030503"]                 , "#psi(2,2.0,4,3,0.5,3)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["011004010502"]                 , "#psi(1,1.0,4,1,0.5,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["030503010502"]                 , "#psi(3,0.5,3,1,0.5,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["021003010502"]                 , "#psi(2,1.0,3,1,0.5,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["012004011003"]                 , "#psi(1,2.0,4,1,1.0,3)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["012004021004"]                 , "#psi(1,2.0,4,2,1.0,4)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["021004012004"]                 , "#psi(2,1.0,4,1,2.0,4)"             , ""           , 'F'); 
      ...
      dataloader->AddVariable( psi["021003012002"]                 , "#psi(2,1.0,3,1,2.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["011004020503"]                 , "#psi(1,1.0,4,2,0.5,3)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["010504010502"]                 , "#psi(1,0.5,4,1,0.5,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["021004021003"]                 , "#psi(2,1.0,4,2,1.0,3)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["012003012002"]                 , "#psi(1,2.0,3,1,2.0,2)"             , ""           , 'F'); 
      dataloader->AddVariable( psi["022004022003"]                 , "#psi(2,2.0,4,2,2.0,3)"             , ""           , 'F'); 
    }
  ...
  vector<int> nCuts={100};
  for(unsigned i=0;i<NTrees.size();i++) for(unsigned j=0;j<MaxDepth.size();j++) for(unsigned k=0;k<AdaBoostBeta.size();k++) for(unsigned l=0;l<nCuts.size();l++)
  ...
  for(unsigned i=0;i<NTrees.size();i++) for(unsigned j=0;j<MaxDepth.size();j++) for(unsigned k=0;k<Shrinkage.size();k++) for(unsigned l=0;l<nCuts.size();l++)
    factory->BookMethod(TMVA::Types::kBDT,
      ...
      Form("!H:!V:BoostType=Grad:MinNodeSize=2.5%%:NegWeightTreatment=Pray:SeparationType=SDivSqrtSPlusB:NTrees=%d:MaxDepth=%d:Shrinkage=%.2f:nCuts=%d",NTrees[i],MaxDepth[j],Shrinkage[k],nCuts[l])
    );
  */
