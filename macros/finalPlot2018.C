...
TCanvas* finalPlot2018(
  ...
  legend1->AddEntry(histos[ kPlotWbb  ], histos[ kPlotWbb  ]->GetTitle(),"f");
  legend1->AddEntry(histos[ kPlotWb   ], histos[ kPlotWb   ]->GetTitle(),"f");
  legend1->AddEntry(histos[ kPlotWLF  ], histos[ kPlotWLF  ]->GetTitle(),"f");
  ...
  legend2->AddEntry(histos[ kPlotVVLF ], histos[ kPlotVVLF ]->GetTitle(),"f");
  legend2->AddEntry(histos[ kPlotVZbb ], histos[ kPlotVZbb ]->GetTitle(),"f");
  legend2->AddEntry(histos[ kPlotVH   ], histos[ kPlotVH   ]->GetTitle(),"lp");
