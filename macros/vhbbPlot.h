...
namespace vhbbPlot {
  ...
  enum selectionType { 
    ...
    kWHHeavyFlavorLoMassCR = 0x1 <<  1,
    kWHHeavyFlavorHiMassCR = 0x1 <<  2,
    kWH2TopCR              = 0x1 <<  3,
    kWHVZbbCR              = 0x1 <<  4,
    kWHSR                  = 0x1 <<  5,
    kWHPresel              = 0x1 <<  6,
    kWHLightFlavorFJCR     = 0x1 <<  7,
    kWHHeavyFlavorFJCR     = 0x1 <<  8,
    kWHTT2bFJCR            = 0x1 <<  9,
    kWHTT1bFJCR            = 0x1 << 10,
    kWHVZbbFJCR            = 0x1 << 11, 
    kWHFJSR                = 0x1 << 12, 
    kWHFJPresel            = 0x1 << 13,
    kZllHLightFlavorCR     = 0x1 << 14,
    kZllHHeavyFlavorCR     = 0x1 << 15,
    kZllH2TopCR            = 0x1 << 16,
    kZllHVZbbCR            = 0x1 << 17,
    kZllHSR                = 0x1 << 18,
    kZllHPresel            = 0x1 << 19,
    kZllHLightFlavorFJCR   = 0x1 << 20,
    kZllHHeavyFlavorFJCR   = 0x1 << 21,
    kZllHTT2bFJCR          = 0x1 << 22,
    kZllHTT1bFJCR          = 0x1 << 23,
    kZllHVZbbFJCR          = 0x1 << 24,
    kZllHFJSR              = 0x1 << 25,
    kZllHFJPresel          = 0x1 << 26,
  ...
  std::map<int, TString> selectionNames={ 
    ...
    { kWHHeavyFlavorLoMassCR    , "HeavyFlavorLoMassCR"    },
    { kWHHeavyFlavorHiMassCR    , "HeavyFlavorHiMassCR"    },
    { kWH2TopCR                 , "2TopCR"           },
    { kWHVZbbCR                 , "VZbbCR"           },
    { kWHSR                     , "SR"               },
    { kWHPresel                 , "Presel"           },
